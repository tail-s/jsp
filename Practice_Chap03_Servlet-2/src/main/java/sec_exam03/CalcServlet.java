...
public class CalcServlet extends HttpServlet {
	...
	private static float USD_RATE = 1320.34F;	//달러
	private static float JPY_RATE = 10.34F;		//엔화
	private static float CNY_RATE = 160.34F;	//위안
	private static float GBP_RATE = 1475.34F;	//파운드
	private static float EUR_RATE = 1280.34F;	//유로
