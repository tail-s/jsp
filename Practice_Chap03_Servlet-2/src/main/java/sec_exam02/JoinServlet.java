...
public class JoinServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//html의 form태그에서 클라이언트가 입력하고 전송한 값을 직접 request객체의 메서드로 얻어서 출력해준다. 여기서 기억해야 할 것은 request, response 객체들은 톰캣 서버가 자동으로 생성시켜준다.
		//아울러, request객체로부터 값을 얻고 응답할 때에는 response객체를 이용한다는 것이다.(중요)
